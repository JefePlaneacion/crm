...
def get_inventarios(db: Session):
    ...
    result =db.query(
        ...
        Bodega.f150_id.label("Código_Bodega"),
    ...
    result_dicts = []
    for inventario, bodega, codigo_bodega,Descripcion_item, referencia_item in result:
        result_dicts.append (
            {
                ...
                "Bodega": bodega,
                "Código_Bodega": codigo_bodega,
                "Descripción_Item": Descripcion_item,
